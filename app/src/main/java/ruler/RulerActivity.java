...
public class RulerActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRulerLayout=findViewById(R.id.add_ruler);
        mRulerNum=findViewById(R.id.ruler_number);
        mRulerLayout.addView(rulerView);
        mRulerNum.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mRulerNum.setText("尺寸："+rulerView.getKedu());
            }
        });
